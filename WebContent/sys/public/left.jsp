...
<head>
    ...
    <script type="text/javascript">
        ...
        function menuClick( menuDiv ){
            $(".MenuLevel2").not( $(menuDiv).next() ).hide();//先把当前的展开的菜单隐藏掉
            $(menuDiv).next().toggle();//next找到对应的一个MenuLevel2 当前显示则隐藏 当前隐藏则显示
        }
...
<body>
   <ul id="Menu">
        ...
        <li class="level1">
            ...
            <ul class="MenuLevel2">
                <li class="level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/table?method=list">修改密码</a>
                </li>
                <li class="level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/foodType?method=list">添加管理员</a>
                </li>
                <li class="level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/food?method=list">修改信息</a>
                </li>
                <li class="level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/Order?method=getOrderList">所有管理员</a>
                </li>
            </ul>
        </li>
    </ul>
